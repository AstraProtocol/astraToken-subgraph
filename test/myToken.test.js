...
describe('MyToken', () => {
  ...
  it('has a default token value', async () => {
    ...
    const value = await deployedContract.methods
  ...
  it('can update token value', async () => {
    ...
    const updatedVal = await deployedContract.methods
      .getTokenBalance(account)
      .call();
...
//   let api ="http://se-api.astra.network/faucet/sip/" +
//   account +
//   "/?" +
//   "endpoint=" +
//   encodeURIComponent(astraEndpoint);
//   console.log(api);
